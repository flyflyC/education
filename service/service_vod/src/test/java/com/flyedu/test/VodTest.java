...
public class VodTest {
    ...
    public static void main(String[] argv) throws ClientException {
        //本地上传
        String accessKeyId = "LTAI4GAL6vhYitNYchcuPv81";
        String accessKeySecret = "Pp6rqANFDG6eysnNYmOn38R45CF98o";

        //上传之后文件名称
        String title = "6 - What If I Want to Move Faster - upload by sdk";
        //本地文件路径和名称
        String fileName = "F:/Wb/1-阿里云上传测试视频/6 - What If I Want to Move Faster.mp4";
