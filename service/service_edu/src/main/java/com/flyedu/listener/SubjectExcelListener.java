 ...
 * @Version
 */
public class SubjectExcelListener extends AnalysisEventListener<SubjectEx> {
     ...
     */
    @Override
    public void invoke(SubjectEx subjectData, AnalysisContext analysisContext) {
        if(subjectData == null) {
